...
export default makeScene2D(function* (view) {
  ...
  view.add(
    <Txt
      ...
      opacity={0}
    >
      Sistemas para dispositivos inalambricos y moviles
    </Txt>,
  );
  ...
  view.add(
    <Circle ref={cir} opacity={0} fill={"white"}>
      <Txt ref={cir_txt}>Intranet</Txt>
    </Circle>,
  );
  yield* all(
    cir[0].width(300, 1),
  ...
  view.add(
    <Txt ref={txt_initial} fill={"white"} opacity={0} position={[0, -250]}>
  ...
  view.add(
    <Line
      ...
      lineWidth={5}
      stroke={"white"}
      points={[[0, 0], [0, 200], [-500, 200], [500, 200]]}
      end={0}
    >
    </Line>,
  );
  ...
  view.add(
    <Txt ref={txt_ar} fill={"white"} opacity={0} position={[-500, 350]}>
      Voz
    </Txt>,
  );
  view.add(
    <Txt ref={txt_ar} fill={"white"} opacity={0} position={[-167, 350]}>
      Video
    </Txt>,
  );
  view.add(
