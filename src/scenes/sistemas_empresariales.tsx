...
export default makeScene2D(function* (view) {
  ...
  const sistemas = (
    <Txt opacity={0} fill={"white"} fontSize={150}>Sistemas empresariales</Txt>
  );
  view.add(sistemas);
  ...
  view.add(
    <Txt ref={SOA} opacity={0} fill={"white"} position={[0, 50]}>SOA</Txt>,
  );
  ...
  view.add(
    <Txt ref={SOA} opacity={0} position={[-50, 250]} fill={"white"}>
      Capa superior
    </Txt>,
  );
  ...
  view.add(
    <Rect ref={erp_rec} fill={"white"} width={200} height={100}>
      <Txt ref={SOA} fill={"black"}>ERP</Txt>
    </Rect>,
  );
  ...
  view.add(
    <Rect
      ...
      position={[-500, 0]}
    >
      <Txt ref={SOA} fill={"black"}>SAP</Txt>
    </Rect>,
  );
  yield* SOA().opacity(1, 1);
  view.add(
    <Rect
      ...
      position={[500, 0]}
    >
      <Txt ref={SOA} fill={"black"}>Oracle</Txt>
    </Rect>,
  );
  yield* SOA().opacity(1, 1);
  ...
  view.add(
    <Rect
      ...
      position={[0, 100]}
    >
      <Txt ref={SOA} fill={"black"}>Capacitacion</Txt>
    </Rect>,
  );
  yield* SOA().opacity(1, 1);
