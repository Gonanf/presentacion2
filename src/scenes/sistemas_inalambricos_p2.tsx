...
export default makeScene2D(function* (view) {
  ...
  view.add(
    <Circle ref={cir} opacity={0} fill={"white"} position={[-600, -200]}>
      <Txt textWrap width={440} textAlign={"center"} ref={cir_txt}>
        M-Commerce
      </Txt>
    </Circle>,
  );
  ...
  view.add(
    <Circle ref={cir} opacity={0} fill={"white"} position={[0, 0]}>
      <Txt ref={cir_txt}>WLAN</Txt>
    </Circle>,
  );
  yield* all(
    cir[1].width(300, 1),
  ...
  view.add(
    <Circle ref={cir} opacity={0} fill={"white"} position={[600, -200]}>
      <Txt ref={cir_txt}>WIFI/Bluethooth</Txt>
    </Circle>,
  );
  yield* all(
    cir[2].width(400, 1),
  ...
  yield* all(
    cir[0].width(500, 1),
    cir[0].height(500, 1),
    cir_txt[0].position([0, -100], 1),
    cir_txt[0].text("Comercio electronico inalambrico", 1),
    svg_rp[0].opacity(1, 1),
  );
  ...
  yield* all(
    cir[2].width(700, 1),
    cir[2].height(700, 1),
    cir_txt[2].position([0, -100], 1),
    ...svg_rp.map((svg) => svg.opacity(1, 1)),
  );
