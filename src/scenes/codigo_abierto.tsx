...
export default makeScene2D(function* (view) {
  ...
  view.add(
    <Txt ref={title} fontSize={150} opacity={0} fill={"white"} textWrap>
  ...
  view.add(
    <Txt ref={title} fill={"whitesmoke"} opacity={0} position={[0, -350]}>
  ...
  view.add(
    <Txt ref={title} fill={"whitesmoke"} opacity={0} position={[0, 0]}>
      Puede ser
    </Txt>,
  );
  yield* title().opacity(1, 1);
  view.add(
    <Line
      ...
      stroke={"white"}
      points={[[0, 50], [0, 100], [-500, 100], [500, 100]]}
    >
    </Line>,
  );
  view.add(
  ...
  view.add(
    <Txt ref={texto} fill={"white"} opacity={0} position={[-500, 250]}>
      Estudiado
    </Txt>,
  );
  view.add(
    <Txt ref={texto} fill={"white"} opacity={0} position={[0, 250]}>
      Compartido
    </Txt>,
  );
  view.add(
