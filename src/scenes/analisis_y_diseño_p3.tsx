...
export default makeScene2D(function* (view) {
  ...
  view.add(
    <Rect
      ...
      position={[0, -400]}
    >
      <Txt ref={analisis}>Analisis y Diseño</Txt>
    </Rect>,
  );
  ...
  view.add(
    <Rect
      ...
      position={[0, 450]}
    >
      <Txt ref={analisis}>Usuarios Software</Txt>
    </Rect>,
  );
  ...
  view.add(
    <Line
      ...
      lineWidth={5}
      stroke={"white"}
      points={[[0, -400], [0, -300], [-300, -300], [300, -300]]}
    >
    </Line>,
  );
  view.add(
  ...
  view.add(
    <Txt ref={text} fill={"white"} position={[-300, -150]}>Analisis</Txt>,
  );
  view.add(
    <Txt ref={text} fill={"white"} position={[300, -150]}>Comunicacion</Txt>,
  );
  ...
  view.add(
    <Txt ref={text} fill={"white"} position={[500, 50]} opacity={0}>
      Diseño del sistema
    </Txt>,
  );
  yield* all(...text.map((tx) => tx.opacity(1, 1)));
  ...
  view.add(
    <Line
      ...
      lineWidth={5}
      stroke={"white"}
      points={[[500, 100], [500, 200], [300, 200]]}
      endArrow
      end={0}
    >
    </Line>,
  ...
  view.add(
    <Line
      ...
      lineWidth={5}
      stroke={"white"}
      points={[[-300, 100], [-300, 200], [-300, 200]]}
      end={0}
    >
    </Line>,
  );
